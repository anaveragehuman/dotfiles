...
mytextclock = awful.widget.textclock(" %a %F %R ")
...
for s = 1, screen.count() do
    ...
    -- Create an imagebox widget which contains an icon indicating current layout. One layoutbox per screen.
    ...
    -- Bring it all together (with tasklist in the middle)
